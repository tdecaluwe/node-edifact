...
let order = [
  { content: 'UNH', mandatory: true, repetition: 1, data: ['ORDERS'] },
  ...
  { content: 'IMD', mandatory: false, repetition: 999 },
  ...
  },
  {
    content: [
      ...
      { content: 'LOC', mandatory: false, repetition: 99 },
  ...
  },
  {
    content: [
      ...
      { content: 'LOC', mandatory: false, repetition: 9 },
    ], mandatory: false, repetition: 5,
  },
  {
    content: [
      { content: 'CUX', mandatory: true, repetition: 1 },
      { content: 'PCD', mandatory: false, repetition: 5 },
      { content: 'DTM', mandatory: false, repetition: 5 },
    ], mandatory: false, repetition: 5,
  },
  {
    content: [
      ...
      { content: 'PCD', mandatory: false, repetition: 1 },
      {
        content: [
          ...
          { content: 'GIR', mandatory: false, repetition: 9 },
          { content: 'RJL', mandatory: false, repetition: 99 },
        ], mandatory: false, repetition: 9999,
      },
  ...
  },
  {
    content: [
      ...
      { content: 'HAN', mandatory: false, repetition: 5 },
      { content: 'MEA', mandatory: false, repetition: 5 },
  ...
  {
    content: [
      { content: 'APR', mandatory: true, repetition: 1 },
      { content: 'DTM', mandatory: false, repetition: 5 },
  ...
  },
  {
    content: [
      ...
      { content: 'RFF', mandatory: false, repetition: 5 },
      { content: 'DTM', mandatory: false, repetition: 5 },
      { content: 'FTX', mandatory: false, repetition: 99999 },
    ], mandatory: false, repetition: 999,
  },
  {
    content: [
      { content: 'DGS', mandatory: true, repetition: 1 },
      { content: 'FTX', mandatory: false, repetition: 5 },
      {
        content: [
          { content: 'CTA', mandatory: true, repetition: 1 },
  ...
  },
  {
    content: [
      ...
      { content: 'MEA', mandatory: false, repetition: 99 },
      { content: 'QTY', mandatory: false, repetition: 99 },
      { content: 'PCD', mandatory: false, repetition: 5 },
      { content: 'ALI', mandatory: false, repetition: 5 },
      { content: 'DTM', mandatory: false, repetition: 35 },
      { content: 'MOA', mandatory: false, repetition: 10 },
      { content: 'GEI', mandatory: false, repetition: 99 },
      ...
      { content: 'DOC', mandatory: false, repetition: 99 },
      { content: 'PAI', mandatory: false, repetition: 1 },
      { content: 'MTD', mandatory: false, repetition: 99 },
      { content: 'FTX', mandatory: false, repetition: 99 },
      {
        content: [
          { content: 'CCI', mandatory: true, repetition: 1 },
          { content: 'CAV', mandatory: false, repetition: 10 },
      ...
      },
      {
        content: [
          ...
          { content: 'APR', mandatory: false, repetition: 99 },
          { content: 'RNG', mandatory: false, repetition: 1 },
          { content: 'DTM', mandatory: false, repetition: 5 },
        ], mandatory: false, repetition: 25,
      },
      ...
      {
        content: [
          { content: 'STG', mandatory: true, repetition: 1 },
          {
            content: [
              { content: 'QTY', mandatory: true, repetition: 1 },
              { content: 'MOA', mandatory: false, repetition: 1 },
  ...
  { content: 'CNT', mandatory: false, repetition: 10 },
  {
    content: [
      ...
      { content: 'MOA', mandatory: true, repetition: 2 },
    ], mandatory: false, repetition: 10,
  },
